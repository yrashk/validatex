defmodule Validatex.NumericalityTest do
  ...
  test :default do
    ...
    assert V.valid?(N.new(default: 1, allow_undefined: true), :undefined) == true
    assert V.valid?(N.new(default: 1, allow_nil: true), nil) == true
    assert V.valid?(N.new(default: 1, allow_string: true, allow_empty: true), "") == true
